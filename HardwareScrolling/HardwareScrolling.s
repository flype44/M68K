;
; HardwareScrolling.s V1.0 20150916
...
; A 640x256x5 playfield is scrolled in a 320x256x5 screen right and left.
; Press left mouse button to exit.
;
; V1.0 20140503 released 08-Aug-2015, first public release
; V1.0 20150916 released 16-Sep-2015: few fixes, now it works as designed
;
; To do list: use a proper startup-code to work also when started from non-native screens
;
...
; }
  ...
  beq.w  DoRightScrolling      ; scroll 1 pixel to right
  bsr.w  DoLeftScrolling       ; scroll 1 pixel to left
  rts
...
DoRightScrolling:
  ...
  swap    d0                   ;
  move.w  6(a0), d0            ;
  addq.l  #2, d0               ; 16 pixel to right
  lea     BPLPOINTERS_1, a1    ; these 4 statements get from copperlist the address where ... points to
  move.w  2(a1), d1            ; and assign it to ...
  swap    d1                   ;
  move.w  6(a1), d1            ;
  addq.l  #2, d1               ; 16 pixel to right
  lea     BPLPOINTERS_2, a2    ; these 4 statements get from copperlist the address where ... points to
  move.w  2(a2), d2            ; and assign it to ...
  swap    d2                   ;
  move.w  6(a2), d2            ;
  addq.l  #2, d2               ; 16 pixel to right
  lea     BPLPOINTERS_3, a3    ; these 4 statements get from copperlist the address where ... points to
  move.w  2(a3), d3            ; and assign it to ...
  swap    d3                   ;
  move.w  6(a3), d3            ;
  addq.l  #2, d3               ; 16 pixel to right
  lea     BPLPOINTERS_4, a4    ; these 4 statements get from copperlist the address where ... points to
  move.w  2(a4), d4            ; and assign it to ...
  swap    d4                   ;
  move.w  6(a4), d4            ;
  addq.l  #2, d4               ; 16 pixel to right
